...
export { clamp, clamp01, step, map, diagonal, distance, smoothStep, lerp, lerp as mix, normalize, randomFloat, randomInt, randomSign, wrap, degToRad, degToRad as toRadians, radToDeg, radToDeg as toDegrees, fuzzyFloor, fuzzyCeil, fuzzyEqual, fuzzyGreaterThan, fuzzyLessThan, maxAdd, minSub, isOdd, isEven, isPowerOfTwo, closestPowerOfTwo, nextPowerOfTwo, percent, average, difference, within, inverseLerp, inverseLerp as inverseMix, lerpUnclamped, lerpUnclamped as mixUnclamped, deltaAngleDeg$$1 as deltaAngleDeg, deltaAngleDeg$$1 as deltaAngle, deltaAngleRad$$1 as deltaAngleRad, fract, mod, lerpAngleDeg$$1 as lerpAngleDeg, lerpAngleDeg$$1 as lerpAngle, lerpAngleRad$$1 as lerpAngleRad, gammaToLinearSpace, linearToGammaSpace, almostIdentity, impulse, cubicPulse, expStep, parabola, powerCurve, smoothMin, smoothMax, deltaTime, gcd };
